# basic LLM prompt "router"
# Using tools/functions, detect the 'intent' of the prompt then route it to the right function
# See examples at bottom of code.
...
def handle_primary_prompt(prompt):
    ...
    try:
        ...
        # This code block should work if Azure supports tool calling
...
OpenAI CALL : ChatCompletion(id='chatcmpl-9YfCg8qRBaefAGaGtjaG9UWv3sUC2', choices=[Choice(finish_reason='tool_calls', index=0, logprobs=None, message=ChatCompletionMessage(content=None, role='assistant', function_call=None, tool_calls=[ChatCompletionMessageToolCall(id='call_vKQqRYGmvbokZIkcUjifHkjZ', function=Function(arguments='{"prompt":"How do I change my 401K withholding percentage?"}', name='answer_benefits_questions'), type='function')]))], created=1718048566, model='gpt-4o-2024-05-13', object='chat.completion', system_fingerprint='fp_319be4768e', usage=CompletionUsage(completion_tokens=27, prompt_tokens=215, total_tokens=242))
In Benefits : {'prompt': 'How do I change my 401K withholding percentage?'}

ENTER PROMPT:
Who is VP of Engineering?
PROMPT:  : Who is VP of Engineering?
OpenAI CALL : ChatCompletion(id='chatcmpl-9YfCu7bt63g4JM2QmQPREQl2nFO7Q', choices=[Choice(finish_reason='tool_calls', index=0, logprobs=None, message=ChatCompletionMessage(content=None, role='assistant', function_call=None, tool_calls=[ChatCompletionMessageToolCall(id='call_7b00fdQtPUVioFfIxnrnXwVK', function=Function(arguments='{"prompt":"Who is VP of Engineering?"}', name='answer_organizational_questions'), type='function')]))], created=1718048580, model='gpt-4o-2024-05-13', object='chat.completion', system_fingerprint='fp_319be4768e', usage=CompletionUsage(completion_tokens=22, prompt_tokens=210, total_tokens=232))
In ORG: : {'prompt': 'Who is VP of Engineering?'}

ENTER PROMPT:
How do I reset my password?
PROMPT:  : How do I reset my password?
OpenAI CALL : ChatCompletion(id='chatcmpl-9YfD5gup6UljGuBWsIkGgrKm4fgtq', choices=[Choice(finish_reason='tool_calls', index=0, logprobs=None, message=ChatCompletionMessage(content=None, role='assistant', function_call=None, tool_calls=[ChatCompletionMessageToolCall(id='call_YdE2AKpKtdurjmv3YhOnOCAy', function=Function(arguments='{"prompt":"How do I reset my password?"}', name='answer_support_questions'), type='function')]))], created=1718048591, model='gpt-4o-2024-05-13', object='chat.completion', system_fingerprint='fp_319be4768e', usage=CompletionUsage(completion_tokens=21, prompt_tokens=211, total_tokens=232))
